                ...
                <li key={index} className="border-b py-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      <button className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded text-sm disabled:bg-gray-400 disabled:cursor-not-allowed" onClick={() => handleClick(file)} disabled={!model || isLoading}>認識</button>
                      <button className="bg-red-500 hover:bg-red-600 p-1 rounded" onClick={() => onClickDeleteFile(index)}>
